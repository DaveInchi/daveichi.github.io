...
function check1level() {
  ...
  if (count == 10 && population == 3) {
    stopLife();
    document.getElementById('info').innerHTML = 'Greate job!';
...
function level3() {
  ...
  document.getElementById('popul').innerHTML = population;
  document.getElementById('info').innerHTML =
    'Размер популяции должен быть равен 5 к 10 пололению';
  drawField();
}
...
function check3level() {
  ...
  if (count == 10 && population == 5) {
    stopLife();
    document.getElementById('info').innerHTML = 'Greate jod!';
...
function level4() {
  ...
  document.getElementById('popul').innerHTML = population;
  document.getElementById('info').innerHTML =
    'Размер популяции должен быть равен 6 к 10 пололению';
  drawField();
}
...
function level5() {
  ...
  document.getElementById('popul').innerHTML = population;
  document.getElementById('info').innerHTML =
    'Размер популяции должен быть равен 7 к 10 пололению';
  drawField();
}

function check5level() {
  count_population;
  if (count == 10 && population == 7) {
    stopLife();
    document.getElementById('info').innerHTML = 'Greate jod!';
  } else if (count == 10 && population != 7) {
    stopLife();
    document.getElementById('info').innerHTML = 'Didn’t work, Try again';
  }
}
